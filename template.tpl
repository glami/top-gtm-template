...

{
  ...
  "description": "GLAMI TOP Opt-in JavaScript code. Using this API your customers can opt-in to GLAMI TOP and express their satisfaction with in a review.",
  "containerContexts": [
    "WEB"
  ]
}
...
const onSuccess = function () {
  ...
  callInWindow('glami_or', 'addParameter', 'item_ids', data.productIds);
  callInWindow('glami_or', 'addParameter', 'item_names', data.productNames);
